...
\begin{itemize}
  ...
  \item \textbf{RDQuant} -- 率失真最优混合精度量化：提出基于率失真优化的逐输出通道混合精度框架，通过 Lagrangian 松弛在给定比特预算下最优分配比特宽度（NVFP4/FP8/FP16）。在 Qwen3-4B 上以 $\sim$5.3 bits/weight 超越 BF16 baseline 困惑度。已集成至 vLLM，在 NVIDIA RTX 5090 上实现 1.9$\times$ 加速。
