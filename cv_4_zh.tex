...
\begin{itemize}
  \item \textbf{RDQuant 集成 vLLM}: 设计混合精度 GEMM 执行 pipeline，包括 channel regrouping、weight repacking 及 multi-format kernel dispatch，在 NVIDIA RTX 5090 上实现 FP16 \textbf{1.9$\times$} 加速。
