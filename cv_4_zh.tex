...
\begin{itemize}
  ...
  \item \textbf{Entropy-Aware NVFP4 量化}：提出逐 block FP8 scale 优化方法，联合最小化重建 MSE 与 codeword entropy，提升后端 compression IP 可压缩性。结合 negative-zero elimination，在精度无损的前提下实现 $\sim$12\% 压缩率提升，输出格式兼容标准 NVFP4。
...
\begin{itemize}
  ...
  \item 设计计算/内存资源分配和 prefetch 调度算法，实现 compute-communication overlap。
