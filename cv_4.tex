...
\begin{itemize}
  \item Developed optimized CUDA kernels for performance-critical ops including \textbf{DeformableAttention}/\textbf{GridSample}/\textbf{Voxelization}/\textbf{BevPoolv2}/\textbf{CoordTransformMatrix}/..., reducing latency to $\sim$1/6 of MMCV baseline.
...
\begin{itemize}
  ...
  \begin{itemize}
    \item Proposed and developed a per-output-channel mixed-precision quantization framework based on \textbf{rate-distortion optimization}. Used Lagrangian relaxation to optimally allocate bit-widths (\textbf{NVFP4}/\textbf{FP8}/\textbf{FP16}) across channels under a given bit budget.
