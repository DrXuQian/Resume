...
\begin{itemize}
  ...
  \begin{itemize}
    ...
    \item Implemented \textbf{MoE W4A16} kernel to support mixture-of-experts models with INT4 weight-only quantization, enabling deployment of \textbf{Qwen3-MoE}.
