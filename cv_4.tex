...
\begin{itemize}
  ...
  \item \textit{LLM Operators}: Optimized \textbf{W4A16 GEMV} kernels for decode-stage shapes (especially $M\!=\!1$), achieving $\sim$80\% memory bandwidth utilization. Implemented \textbf{MoE W4A16} kernel to support mixture-of-experts models with INT4 weight-only quantization, enabling deployment of \textbf{Qwen3-MoE}. Identified and fixed a traffic anomaly in the \textbf{FP8 GEMM} operator on the performance model.
\end{itemize}
